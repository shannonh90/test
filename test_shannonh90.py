...
def f06(string1, string2):
    ...
    percentage = (len_string2/len_string1)*100
...
def various_solutions():
    ...
    #while_ = f07(x) #this one doesnt work for me
    for_ = f08()
...
def f07():
    total_sum = 0
    while n in range(1,500):
        if n % 3 == 0 or n % 5 == 0:
            total_sum = total_sum + n
    print(total_sum)

#i always have trouble with while statements! 
...
###############################################################################
def f09():
    print(sum(n for n in range(1, 500) if (n % 3 == 0) or (n % 5 == 0)))
...
#having trouble with this one, moving onto the next. 
#im over thinking it
